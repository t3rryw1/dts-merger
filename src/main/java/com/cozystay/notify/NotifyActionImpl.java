...
public class NotifyActionImpl implements NotifyAction{
    public final String requestUrl;
    public final NotifyRule.requestMethod requestMethod;
    ...
    public NotifyActionImpl (String url,
                         NotifyRule.requestMethod method,
